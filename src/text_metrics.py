...
class QuadMetric:
    ...
    def measure(self, batch, output,value,is_output_polygon=False, box_thresh=0.6):
        '''
        ...
        ignore_tags_batch = batch['ignore_tags'][0]
        gt = []
        ...
        results.append(self.evaluator.evaluate_image(gt, pred,value),)
        return results
    ...
    def validate_measure(self,
                         ...
                         box_thresh=0.6,):
        return self.measure(batch, output,data, is_output_polygon, box_thresh)
    ...
    def gather_measure(self, raw_metrics):
        ...
        # TODO 端到端的--------------------------------
        E2E_precision = AverageMeter()
        E2E_recall = AverageMeter()
        E2E_fmeasure = AverageMeter()

        E2E_precision.update(result['E2E_precision'], n=len(raw_metrics))
        E2E_recall.update(result['E2E_recall'], n=len(raw_metrics))
        E2E_fmeasure_score = 2 * E2E_precision.val * E2E_recall.val / (E2E_precision.val +
                                                           E2E_recall.val + 1e-8)
        E2E_fmeasure.update(E2E_fmeasure_score)
        return {'precision': precision, 'recall': recall,
                'fmeasure': fmeasure,'E2E_precision': E2E_precision, 'E2E_recall': E2E_recall, 'E2E_fmeasure': E2E_fmeasure}
