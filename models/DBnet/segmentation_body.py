...
class SeparableConv2d(nn.Module):
    ...
    def forward(self, x):
        ...
        return x
# 创建四个 3x224x224 的张量
# tensor1 = torch.randn(1,64, 56, 56)
# tensor2 = torch.randn(1,128, 28, 28)
# tensor3 = torch.randn(1,256, 14, 14)
# tensor4 = torch.randn(1,512, 7, 7)
#
# # 将这些张量放入一个元组中
# tensor_tuple = [tensor1, tensor2, tensor3, tensor4]
# model = FPN([64,128,256,512])
# print(model)
# model(tensor_tuple)
